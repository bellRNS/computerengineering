...
def draw_word(screen, spaces):
    ...
    for i in range(spaces):
        pygame.draw.line(screen, YELLOW, (x, 350), (x+20, 350), 3)  #for each space given, draw a segment then jump 30
        x += 30
...
def main():
    ...
    body = ['l_leg', 'r_leg', 'l_arm', 'r_arm', 'body', 'head'] #Creates a list of body objects to choose and delete from
